...
public class ProjectMemberTest extends AbstractDatabaseTest {
	...
	public void testgetAssignedActivities()  {
		as.addActivity(new Activity(null, as.getProject().getId(), Status.NEW, 0, 5, "Label", 0, 5, 5, 5, 0, "Desc", 0));
	...
	public void testgetAssignedProjects()  {
        ...
        as.addActivity(new Activity(null, as.getProject().getId(), Status.NEW, 0, 5, "Label", 0, 5, 5, 5, 0, "Desc", 0));
        as2.addActivity(new Activity(null, as2.getProject().getId(), Status.NEW, 0, 35, "Label3", 0, 35, 35, 35, 0, "Desc3", 0));
