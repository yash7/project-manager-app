...
public class ActivityRecord extends UpdatableRecordImpl<ActivityRecord> implements Record11<Integer, Integer, Status, Integer, Integer, String, Integer, Integer, Integer, Integer, String> {

	private static final long serialVersionUID = -816155257;
	 ...
	 */
	@Override
	public Row11<Integer, Integer, Status, Integer, Integer, String, Integer, Integer, Integer, Integer, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row11<Integer, Integer, Status, Integer, Integer, String, Integer, Integer, Integer, Integer, String> valuesRow() {
	 ...
	 */
	@Override
	public ActivityRecord values(Integer value1, Integer value2, Status value3, Integer value4, Integer value5, String value6, Integer value7, Integer value8, Integer value9, Integer value10, String value11) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ActivityRecord(Integer id, Integer projectId, Status status, Integer earliestStart, Integer earliestFinish, String label, Integer latestStart, Integer latestFinish, Integer duration, Integer maxDuration, String description) {
		super(ActivityTable.ACTIVITY);
