...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record5<Integer, String, String, Boolean, Integer> {
	 ...
	 */
	@Override
	public ProjectRecord values(Integer value1, String value2, String value3, Boolean value4, Integer value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ProjectRecord(Integer id, String projectName, String description, Boolean completed, Integer budgetAtCompletion) {
		super(ProjectTable.PROJECT);
