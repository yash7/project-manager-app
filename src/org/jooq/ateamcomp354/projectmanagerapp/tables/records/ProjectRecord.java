...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record4<Integer, String, String, Boolean> {

	private static final long serialVersionUID = 1659480654;
	 ...
	 */
	@Override
	public ProjectRecord values(Integer value1, String value2, String value3, Boolean value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ProjectRecord(Integer id, String projectName, String description, Boolean completed) {
		super(ProjectTable.PROJECT);
