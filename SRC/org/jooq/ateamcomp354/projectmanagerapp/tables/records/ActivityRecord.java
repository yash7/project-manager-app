...
public class ActivityRecord extends UpdatableRecordImpl<ActivityRecord> implements Record13<Integer, Integer, Status, Integer, Integer, String, Integer, Integer, Integer, Integer, Integer, String, Integer> {

	private static final long serialVersionUID = 1256140750;
	 ...
	 */
	@Override
	public Row13<Integer, Integer, Status, Integer, Integer, String, Integer, Integer, Integer, Integer, Integer, String, Integer> fieldsRow() {
	 ...
	 */
	@Override
	public Row13<Integer, Integer, Status, Integer, Integer, String, Integer, Integer, Integer, Integer, Integer, String, Integer> valuesRow() {
	 ...
	 */
	@Override
	public ActivityRecord values(Integer value1, Integer value2, Status value3, Integer value4, Integer value5, String value6, Integer value7, Integer value8, Integer value9, Integer value10, Integer value11, String value12, Integer value13) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ActivityRecord(Integer id, Integer projectId, Status status, Integer earliestStart, Integer earliestFinish, String label, Integer latestStart, Integer latestFinish, Integer duration, Integer maxDuration, Integer float_, String description, Integer plannedValue) {
		super(ActivityTable.ACTIVITY);
